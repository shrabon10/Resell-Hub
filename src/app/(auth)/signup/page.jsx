...
const SignUpPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data: session, error: apiError } =
            ...
            if (apiError) {
                setError(
                    apiError.message || 'An error occurred during sign up.',
                );
                setLoading(false);
                return;
            }
            ...
            >
                ...
                >
                    ...
                    <div className="relative z-10 mt-8 space-y-3 text-center max-w-sm">
                        ...
                        <p className="text-sm text-muted-foreground/80 leading-relaxed font-medium">
                            Create an account to unlock premium trading
                            capabilities, real-time analytics, and
                            standard-setting execution.
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        <Link
                            href="/signIn"
                            className="font-bold text-primary hover:text-primary/80 underline-offset-4 hover:underline transition-colors"
                        >
                            Sign In
                        </Link>
                    </motion.p>
